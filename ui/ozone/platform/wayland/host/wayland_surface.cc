...
std::optional<bool> WaylandSurface::ApplyPendingState() {
  ...
  if (wp_color_management_surface_ &&
    ...
    wp_color_management_surface_->SetColorSpace(
        pending_state_.color_space,
        pending_state_.hdr_metadata.value_or(gfx::HDRMetadata()));
    needs_commit = true;
  }
...
void WaylandSurface::SetImageDescription(
