...
#define GBM_BO_USE_TEXTURING GBM_BO_USE_RENDERING
#define GBM_BO_USE_CAMERA_WRITE 0
#define GBM_BO_USE_HW_VIDEO_DECODER GBM_BO_USE_RENDERING
#define GBM_BO_USE_HW_VIDEO_ENCODER GBM_BO_USE_RENDERING
